...
F_age_path <- here("raw-data","summer_flounder_F_table_by_age.pdf")
...
F_path <- here("raw-data","summer_flounder_F_table.pdf")
...
wt_path <- here("raw-data","summer_flounder_weight_at_age_tables.pdf")
